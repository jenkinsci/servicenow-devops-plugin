...
import io.jenkins.plugins.pipeline.steps.executions.DevOpsConfigPublishStepExecution;
import io.jenkins.plugins.utils.DevOpsConstants;

public class DevOpsConfigPublishStep extends Step implements Serializable{
    ...
    public StepExecution start(StepContext context) throws Exception {
        return new DevOpsConfigPublishStepExecution(context, this);
    }
	...
	public static class DescriptorImpl extends StepDescriptor {
		...
		public String getFunctionName() {
			return DevOpsConstants.CONFIG_PUBLISH_STEP_FUNCTION_NAME.toString();
		}

		@Override
		public String getDisplayName() {
			return DevOpsConstants.CONFIG_PUBLISH_STEP_DISPLAY_NAME.toString();
		}
